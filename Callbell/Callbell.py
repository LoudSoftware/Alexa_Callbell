...
def internet_on(): #Connecting to Amazon Alexa voice Service
...
def alexa(): #This is called when the call button is pressed and wav recording is made.
...
if __name__ == "__main__":
	...
	while internet_on() == False:
		print "."
	token = gettoken()
	os.system('mpg123 -q -a hw:2,0 {}hello.mp3 {}1sec.mp3'.format(path, path)) #plays on startup
	for x in range(0, 3):
		time.sleep(.1)
		GPIO.output(24, GPIO.HIGH)
		time.sleep(.1)
